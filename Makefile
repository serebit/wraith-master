...
ifneq ("$(wildcard build/PACKAGE/udev/99-wraith-master.rules)","")
	install -Dm 0644 resources/common/99-wraith-master.rules $(UDEVDIR)/99-wraith-master.rules
endif

install-cli: build/PACKAGE/wraith-master
	install -Dm 0755 build/PACKAGE/wraith-master $(BINDIR)/wraith-master
ifneq ("$(wildcard build/PACKAGE/man/wraith-master.1)","")
	install -Dm 0644 build/PACKAGE/man/wraith-master.1 $(MANDIR)/man1/wraith-master.1
endif

install-gtk: build/PACKAGE/wraith-master-gtk
	install -Dm 0755 build/PACKAGE/wraith-master-gtk $(BINDIR)/wraith-master-gtk
	install -Dm 0644 build/PACKAGE/desktop/wraith-master.desktop $(SHAREDIR)/applications/wraith-master.desktop
	install -Dm 0644 build/PACKAGE/icons/wraith-master.svg $(SHAREDIR)/icons/hicolor/scalable/apps/wraith-master.svg
ifneq ("$(wildcard build/PACKAGE/man/wraith-master-gtk.1)","")
	install -Dm 0644 build/PACKAGE/man/wraith-master-gtk.1 $(MANDIR)/man1/wraith-master-gtk.1
endif
